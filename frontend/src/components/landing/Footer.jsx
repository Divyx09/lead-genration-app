  ...
  return (
    <footer className="bg-secondary text-white">
      ...
      <div className="relative">
        ...
        <div className="bg-[#2563EB] py-6 shadow-lg">
          <div className="container-custom">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 max-w-7xl mx-auto px-4">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
                <span className="text-white font-semibold text-sm whitespace-nowrap tracking-wide">Subscribe Us</span>
                <form onSubmit={handleSubscribe} className="flex w-full sm:w-auto shadow-xl">
                  <input
                    ...
                    className="px-5 py-3 rounded-l-lg focus:outline-none border border-white text-white placeholder-white/70 w-full sm:w-72 text-sm bg-[#2563EB]"
                    required
                    disabled={loading}
                  />
                  <button 
                    type="submit" 
                    className="bg-white text-[#2563EB] hover:bg-gray-50 px-8 py-3 rounded-r-lg font-semibold transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm shadow-lg whitespace-nowrap"
                    disabled={loading}
                  >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6">
              Empowering businesses with quality leads and proven growth strategies.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="hover:text-primary transition cursor-pointer">Lead Generation</li>
              <li className="hover:text-primary transition cursor-pointer">Financial Services</li>
              <li className="hover:text-primary transition cursor-pointer">Creative Design</li>
              <li className="hover:text-primary transition cursor-pointer">Real Estate</li>
              <li className="hover:text-primary transition cursor-pointer">Business Consulting</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@leadgen.com" className="hover:text-primary transition">
                  info@realestate.com
                </a>
              </li>
            </ul>
